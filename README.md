...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2gh9ebm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2gh9ebm.containers.anotherwebservice.com/
...
```
git clone git@github.com:ktz-master/container-2gh9ebm.git
cd container-2gh9ebm
```
...
```
docker attach container-2gh9ebm
```
